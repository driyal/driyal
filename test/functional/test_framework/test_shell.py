...
class TestShell:
    """Wrapper Class for DRiyalTestFramework.

    The TestShell class extends the DRiyalTestFramework
    ...
    class __TestShell(DRiyalTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by DRiyalTestFramework child class.
            self.num_nodes = 1
