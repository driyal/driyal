...
"""Verify that starting driyal with -h works as expected."""

from test_framework.test_framework import DRiyalTestFramework
from test_framework.util import assert_equal

class HelpTest(DRiyalTestFramework):
    ...
    def run_test(self):
        self.log.info("Start driyal with -h for help text")
        ...
        self.log.info("Start driyal with -version for version information")
        ...
        self.log.info("Start driyald with -fakearg to make sure it does not start")
