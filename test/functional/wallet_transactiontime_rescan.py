...
class TransactionTimeRescanTest(DRiyalTestFramework):
    ...
    def run_test(self):
        ...
        minernode = self.nodes[0]  # node used to mine DRI and create transactions
        ...
        # generate some DRI to create transactions and check blockcount
        ...
        # send 10 DRI to user's first watch-only address
        self.log.info('Send 10 DRI to user')
        ...
        # send 5 DRI to our second watch-only address
        self.log.info('Send 5 DRI to user')
        ...
        # send 1 DRI to our third watch-only address
        self.log.info('Send 1 DRI to user')
