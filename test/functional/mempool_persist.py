...
By default, driyald will dump mempool on shutdown and
...
class MempoolPersistTest(DRiyalTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent driyald from writing mempool.dat to disk. Verify that `savemempool` fails")
