...
class TxnMallTest(DRiyalTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 DRI:
        ...
        # First: use raw transaction API to send 1240 DRI to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 DRI coin each
        ...
        # Node0's balance should be starting balance, plus 50DRI for another
        ...
        # Node0's total balance should be starting balance, plus 100DRI for
