...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the DRiyalTestFramework
    pass


class ExampleTest(DRiyalTestFramework):
    # Each functional test is a subclass of the DRiyalTestFramework class.
    ...
    def custom_method(self):
        ...
        DRiyalTestFramework class so other tests can use it."""
