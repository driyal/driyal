...
class P2PPermissionsTests(DRiyalTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].driyalconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].driyalconf, 'w', encoding="utf8") as f:
            f.write(newText)
