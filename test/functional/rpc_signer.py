...
Verify that a driyald node can use an external signer command.
...
class RPCSignerTest(DRiyalTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart driyald with -signer=<cmd>',
