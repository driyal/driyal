...
if [ "$CI_OS_NAME" == "macos" ]; then
  echo > "${HOME}/Library/Application Support/DRiyal"
else
  DOCKER_EXEC echo \> \$HOME/.driyal
fi
...
if [[ ${USE_MEMORY_SANITIZER} == "true" ]]; then
  ...
  # from depends. See https://github.com/driyal/driyal/pull/18288#discussion_r433189350 for
  # details.
