...
This document provides guidelines for internationalization of the DRiyal Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `driyal_en.ts` remains unchanged.
