DRiyal Core version *0.15.2* is now available from:

  <https://driyalcore.org/bin/driyal-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in driyal-tx (TheBlueMatt)
