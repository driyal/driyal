DRiyal-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/driyal/files/DRiyal/driyal-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the DRiyal
...
New/changed settings (command-line or driyal.conf file)
--------------------------------------------------------
