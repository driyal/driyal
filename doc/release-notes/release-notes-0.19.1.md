...
DRiyal Core version 0.19.1 is now available from:

  <https://driyalcore.org/bin/driyal-core-0.19.1/>
...
From DRiyal Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as DRiyal Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, DRiyal Core does not yet change appearance when
...
- #17488 fix "driyald already running" warnings on macOS (fanquake)
