DRiyal Core version 0.13.2 is now available from:

  <https://driyal.org/bin/driyal-core-0.13.2/>
...
- #8908 `4a974b2` Update driyal-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow driyal-tx to create v2 transactions (DRIdrak)
