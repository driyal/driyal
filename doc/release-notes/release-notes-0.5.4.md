DRiyal version 0.5.4 is now available for download at:
http://sourceforge.net/projects/driyal/files/DRiyal/driyal-0.5.4/
...
http://gitorious.org/driyal/driyald-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix DRiyal-Qt notifications under Growl 1.3.
Increase required age of DRiyal-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxDRiyal properly when installing DRiyal-Qt over it. (Windows)
