DRiyal Core version 0.16.1 is now available from:

  <https://driyalcore.org/bin/driyal-core-0.16.1/>
...
- #12843 `df38b13` Test starting driyald with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure driyald processes are cleaned up when tests end (sdaftuar)
