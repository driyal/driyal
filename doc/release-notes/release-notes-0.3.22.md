Download URL: https://sourceforge.net/projects/driyal/files/DRiyal/driyal-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 DRI fee schedule (users still pay 0.01 DRI per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #driyal00 - #driyal99
