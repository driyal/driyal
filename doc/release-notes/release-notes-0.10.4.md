DRiyal Core version 0.10.4 is now available from:

  <https://driyal.org/bin/driyal-core-0.10.4/>
...
- #6953 `43c2789` Split driyal-tx into its own package
- #6953 `dfe0d4d` Include driyal-tx binary on Debian/Ubuntu
