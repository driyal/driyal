DRiyal Core version 0.9.4 is now available from:

  https://driyal.org/bin/0.9.4/
...
this update is incompatible with the DRiyal system and could lead to consensus
forks.

DRiyal Core released binaries from https://driyal.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~driyal/+archive/ubuntu/driyal
- A third-party or self-compiled DRiyal Core

upgrade to DRiyal Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
