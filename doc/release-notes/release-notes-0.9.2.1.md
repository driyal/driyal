DRiyal Core version 0.9.2.1 is now available from:

  https://driyal.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 DRI to 0.01 DRI
...
- Fix "Start driyal on system login"
