...
Assumeutxo is a feature that allows fast bootstrapping of a validating driyald
...
- [Github issue](https://github.com/driyal/driyal/issues/15605)
- [draft PR](https://github.com/driyal/driyal/pull/15606)
...
considered active. This is the "traditional" mode of operation for driyald.
...
**Failure consideration:** if driyald unexpectedly halts after `m_stop_use` is set on
...
### DRiyald restarts sometime after snapshot validation has completed

When driyald initializes again, what began as the snapshot chainstate is now
