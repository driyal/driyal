...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef DRIYAL_CHAINPARAMSSEEDS_H\n')
    g.write('#define DRIYAL_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the driyal network\n')
    ...
    g.write('#endif // DRIYAL_CHAINPARAMSSEEDS_H\n')
