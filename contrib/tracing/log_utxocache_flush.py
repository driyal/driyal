...
"""Example logging DRiyal Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/driyald
...
def main(driyald_path):
    ...
    b = BPF(text=program, usdt_contexts=[driyald_with_usdts])
