...
(define* (make-driyal-cross-toolchain target
                                       #:key
...
desirable for building DRiyal Core release binaries."
...
(define-public glibc-2.27/driyal-patched
  (package
    (inherit glibc-2.31)
    (version "2.27")
    (source (origin
    ...
    (cond ((string-suffix? "-mingw32" target)
          ...
          ((string-contains target "-linux-")
           (list (cond ((string-contains target "riscv64-")
                        (make-driyal-cross-toolchain target
                                                      #:base-libc glibc-2.27/driyal-patched
