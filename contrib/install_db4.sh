...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the driyal repository."
  exit 1
fi
...
# See https://github.com/driyal/driyal/issues/16064
...
echo 'When compiling driyald, run `./configure` in the following way:'
echo
