...
"""Script for verifying DRiyal Core release binaries

This script attempts to download the signature file SHA256SUMS.asc from
driyalcore.org and driyal.org and compares them.
...
WORKINGDIR = "/tmp/driyal_verify_binaries"
HASHFILE = "hashes.tmp"
HOST1 = "https://driyalcore.org"
HOST2 = "https://driyal.org"
VERSIONPREFIX = "driyal-core-"
...
def main(args):
    ...
    if not success:
        print("driyal.org failed to provide signature file, "
              "but driyalcore.org did?")
        print("wget output:")
        print(indent(output, '\t'))
    ...
    if not files_are_equal(sigfile1, sigfile2):
        print("driyal.org and driyalcore.org signature files were not equal?")
    ...
    if retval != 0:
        if retval == 1:
            ...
            print("gpg error. Do you have the DRiyal Core binary release "
