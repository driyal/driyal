...
def tree_sha512sum(commit='HEAD'):
    ...
    This is copied from github-merge.py. See https://github.com/driyal-core/driyal-maintainer-tools."""
...
def main():
    ...
    while True:
        ...
        os.environ['DRIYAL_VERIFY_COMMITS_ALLOW_SHA1'] = "0" if no_sha1 else "1"
        os.environ['DRIYAL_VERIFY_COMMITS_ALLOW_REVSIG'] = "1" if current_commit in revsig_allowed else "0"
