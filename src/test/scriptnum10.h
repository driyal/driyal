...
#ifndef DRIYAL_TEST_SCRIPTNUM10_H
#define DRIYAL_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from DRiyal Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // DRIYAL_TEST_SCRIPTNUM10_H
