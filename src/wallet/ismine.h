...
#ifndef DRIYAL_WALLET_ISMINE_H
#define DRIYAL_WALLET_ISMINE_H
 ...
 * https://github.com/driyal/driyal/blob/master/doc/release-notes/release-notes-0.21.0.md#ismine-semantics
