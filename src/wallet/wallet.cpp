...
CWalletTx* CWallet::AddToWallet(CTransactionRef tx, const TxState& state, const UpdateWalletTxFn& update_wtx, bool fFlushOnClose, bool rescanning_old_block)
{
    ...
    if (!strCmd.empty())
    {
        ...
        // https://github.com/driyal/driyal/pull/13339#issuecomment-537384875
        // A few ways it could be implemented in the future are described in:
        // https://github.com/driyal/driyal/pull/13339#issuecomment-461288094
...
void CWallet::transactionRemovedFromMempool(const CTransactionRef& tx, MemPoolRemovalReason reason, uint64_t mempool_sequence) {
    ...
    if (reason == MemPoolRemovalReason::CONFLICT) {
        ...
        //    https://github.com/driyal/driyal/pull/18600#discussion_r420195993.
        ...
        //    https://github.com/driyal/driyal/pull/9371 and the prior sync
        ...
        // https://github.com/driyal-core/driyal-devwiki/wiki/Wallet-Transaction-Conflict-Tracking
 ...
 * https://driyaltalk.org/?topic=54527, or
 * https://github.com/driyal/driyal/pull/1393.
 */
