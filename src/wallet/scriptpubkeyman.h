...
#ifndef DRIYAL_WALLET_SCRIPTPUBKEYMAN_H
#define DRIYAL_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The DRiyal Core wallet was originally a collection of unrelated private
...
#endif // DRIYAL_WALLET_SCRIPTPUBKEYMAN_H
