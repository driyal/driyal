...
#ifndef DRIYAL_WALLET_WALLETUTIL_H
#define DRIYAL_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! driyal from opening the wallet, thinking it was newly created, and
...
#endif // DRIYAL_WALLET_WALLETUTIL_H
