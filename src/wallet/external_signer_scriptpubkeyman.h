...
#ifndef DRIYAL_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define DRIYAL_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // DRIYAL_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
