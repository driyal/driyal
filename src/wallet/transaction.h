...
#ifndef DRIYAL_WALLET_TRANSACTION_H
#define DRIYAL_WALLET_TRANSACTION_H
...
public:
     ...
     * on this driyal node, and set to 0 for transactions that were created
...
#endif // DRIYAL_WALLET_TRANSACTION_H
