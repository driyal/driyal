...
#ifndef DRIYAL_INTERFACES_INIT_H
#define DRIYAL_INTERFACES_INIT_H
...
//! (driyal-gui, driyal-node, driyal-wallet, driyald, driyal-qt) and each
...
#endif // DRIYAL_INTERFACES_INIT_H
