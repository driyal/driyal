 ...
 */
#ifndef DRIYAL_UTIL_SYSTEM_H
#define DRIYAL_UTIL_SYSTEM_H
...
extern const char * const DRIYAL_CONF_FILENAME;
extern const char * const DRIYAL_SETTINGS_FILENAME;
