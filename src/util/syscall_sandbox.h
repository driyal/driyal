...
#ifndef DRIYAL_UTIL_SYSCALL_SANDBOX_H
#define DRIYAL_UTIL_SYSCALL_SANDBOX_H
...
//!
//! SetupSyscallSandbox(...) is called during driyald initialization if DRiyal Core was compiled
...
#endif // DRIYAL_UTIL_SYSCALL_SANDBOX_H
