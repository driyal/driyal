...
#ifndef DRIYAL_COMPAT_ASSUMPTIONS_H
#define DRIYAL_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "DRiyal cannot be compiled without assertions."
#endif
...
#endif // DRIYAL_COMPAT_ASSUMPTIONS_H
