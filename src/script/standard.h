...
#ifndef DRIYAL_SCRIPT_STANDARD_H
#define DRIYAL_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a driyal address
 */
...
/**
 * Generate a DRiyal scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // DRIYAL_SCRIPT_STANDARD_H
