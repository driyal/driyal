...
#ifndef DRIYAL_RPC_PROTOCOL_H
#define DRIYAL_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in driyald
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< DRiyal is not connected
