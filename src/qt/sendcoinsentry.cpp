    ...
    platformStyle(_platformStyle)
{
    ...
    // normal driyal address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying driyal address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &DRiyalAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
