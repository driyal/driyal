...
#ifndef DRIYAL_QT_WALLETVIEW_H
#define DRIYAL_QT_WALLETVIEW_H
...
private:
    ...
    //!
    //! The wallet model represents a driyal wallet, and offers access to
