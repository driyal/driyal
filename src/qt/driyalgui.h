...
#ifndef DRIYAL_QT_DRIYALGUI_H
#define DRIYAL_QT_DRIYALGUI_H
...
/**
  DRiyal GUI main class. This class represents the main window of the DRiyal UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class DRiyalGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit DRiyalGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~DRiyalGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a driyal wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    /** Load Partially Signed DRiyal Transaction from file or clipboard */
