...
#ifndef DRIYAL_QT_RECEIVECOINSDIALOG_H
#define DRIYAL_QT_RECEIVECOINSDIALOG_H
...
/** Dialog for requesting payment of driyals */
...
#endif // DRIYAL_QT_RECEIVECOINSDIALOG_H
