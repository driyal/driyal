...
//! Entry point for DRiyalApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &DRiyalApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for DRiyalGUI tests.
void AppTests::guiTests(DRiyalGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &DRiyalGUI::consoleShown, this, &AppTests::consoleTests);
