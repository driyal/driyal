    ...
    mapper(nullptr)
{
    ...
    ui->driyalAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->driyalAtStartup);
    ...
    ui->driyalAtStartup->setToolTip(ui->driyalAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->driyalAtStartup->setText(ui->driyalAtStartup->text().arg(PACKAGE_NAME));

    ui->openDRiyalConfButton->setToolTip(ui->openDRiyalConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new DRiyalUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->driyalAtStartup, OptionsModel::StartAtStartup);
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSDRIontrols);
...
void OptionsDialog::on_openDRiyalConfButton_clicked()
{
