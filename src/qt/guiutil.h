...
#ifndef DRIYAL_QT_GUIUTIL_H
#define DRIYAL_QT_GUIUTIL_H
...
/** Utility functions used by the DRiyal Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "driyal:" URI into recipient object, return true on successful parsing
