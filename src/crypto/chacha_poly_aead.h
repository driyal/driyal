...
#ifndef DRIYAL_CRYPTO_CHACHA_POLY_AEAD_H
#define DRIYAL_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@driyal.
 *
 ...
 *
 * The chacha20-poly1305@driyal combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@driyal cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@driyal are relatively fast in
...
#endif // DRIYAL_CRYPTO_CHACHA_POLY_AEAD_H
